...
<p style="color:red;">Page 1[Home]</p>
<p style="color:red;">Converter Site</p>
1. <a href="http://localhost/lab/home.php">Home</a>
</a></h1> 
2.<a href="http://localhost/lab/conversion.php">Convertion site</a>
</a></h1>
3. <a href="http://localhost/lab/history.php">History</a></a></h1>  
<p style="color:red;">Converter: </p>


  <select name="from">
            
            <option value=0>feet to inch &#8681;</option>
